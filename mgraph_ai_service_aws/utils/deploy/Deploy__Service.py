...
from mgraph_ai_service_aws.config                                  import SERVICE_NAME, LAMBDA_DEPENDENCIES__AWS__SERVICE
from mgraph_ai_service_aws.fast_api.lambda_handler                 import run
...
class Deploy__Service(Deploy__Serverless__Fast_API):
    ...
    def lambda_dependencies(self):
        return LAMBDA_DEPENDENCIES__AWS__SERVICE
