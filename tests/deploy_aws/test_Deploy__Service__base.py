...
from mgraph_ai_service_aws.config                                  import LAMBDA_DEPENDENCIES__AWS__SERVICE
from mgraph_ai_service_aws.utils.Version                           import version__mgraph_ai_service_aws
from mgraph_ai_service_aws.utils.deploy.Deploy__Service            import Deploy__Service
...
class test_Deploy__Service__base():     # Base class for deployment tests - override stage in subclasses
    ...
    def test_2__upload_dependencies(self):
        ...
        assert list_set(upload_results) == LAMBDA_DEPENDENCIES__AWS__SERVICE
    ...
    def test_5__invoke__function_url(self):
        version = {'version': version__mgraph_ai_service_aws}
